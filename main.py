...
print("2 - Render Bonificada")
print("3 - Consultar Saldo Conta")
print("4 - Depositar na Conta")
print("5 - Sacar na Conta")
...
while escolha > 0:
    if escolha == 1:
        ...
        print("Conta Bonificada...")
        numConta = int(input("digite o numero da conta bonificada:"))
        resp = bancoUfrpe.renderBonificada(numConta)
        if resp:
